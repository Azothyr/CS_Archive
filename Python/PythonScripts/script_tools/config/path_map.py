...
'maya_info': os.path.join(os.path.expanduser('~'), 'Documents', 'custom_scripts', 'maya_scripts', 'config'),
...
'tools_file_path_library': os.path.join(os.path.expanduser('~'), 'Documents', 'custom_scripts', 'script_tools',
                                        'path_library_Manager.py'),
...
'tools_format_tool': os.path.join(os.path.expanduser('~'), 'Documents', 'custom_scripts', 'script_tools', 'dict_ops.py'),
...
'tools_config_manager': os.path.join(os.path.expanduser('~'), 'Documents', 'custom_scripts', 'script_tools', 'debug_config_manager.py'),
