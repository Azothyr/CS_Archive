...
def draw_flower(screen_width, screen_height, flower_size, petal_count, flower_position,
    ...
    """Draws the full flower. Broken up into nested function"""
    turtle.penup()
    turtle.goto(flower_position)
    turtle.pendown()

    def flower_petals():
        """Portion of parent function that draws petals"""
    ...
    def flower_stem():
        """Portion of parent function that draws the stem"""
    ...
    def ground():
        """Portion of parent function that draws the dirt"""
