...
class Candy(DessertItem):
    def __init__(self, name="", candy_weight=0.0, price_per_pound=0.0, tax_percent=7.25):
        ...
        self.__name__ = f"{self.name} Candy"

    def __str__(self):
        name = self.__name__
        quantity = f"{self.candy_weight}lbs"
        price = "${:.2f}".format(self.price_per_pound) + "/lb"
        item_cost = self.calculate_cost()
        item_tax = self.calculate_tax()
...
class Cookie(DessertItem):
    def __init__(self, name="", cookie_quantity=0, price_per_dozen=0.0, tax_percent=7.25):
        ...
        self.__name__ = f"{self.name} Cookie"
...
class IceCream(DessertItem):
    def __init__(self, name="", scoop_count=0, price_per_scoop=0.0, tax_percent=7.25):
        ...
        self.__name__ = f"{self.name} IceCream"
...
class Sundae(IceCream):
    def __init__(self, name="", scoop_count=0, price_per_scoop=0.0,
        ...
        self.__name__ = f"{self.topping_name} {self.name} Sundae"
