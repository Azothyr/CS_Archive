...
class DataCalculator:
    ...
    Properties:
        data (List[Union[int, float]]): List of data to analyze
    ...
    Methods:
        __init__(data: List[Union[int, float]]): Initialize the DataCalculator class
        ...
        _validate_data(in_data: List[Union[int, float]]): Validate the data
    ...
    @data.setter
    def data(self, value: List[Union[int, float]]):
